...
export const es: typeof en = {
  ...
  home: {
    ...
    whyP3: "Ya sea que estés planeando una escapada romántica, viajes de lujo para mujeres solas, una aventura familiar, una boda destino o viajes corporativos e incentivos, aportamos el mismo nivel de cuidado. Solicita tu consulta gratuita de agente de viajes hoy. Como agente de viajes bilingüe basado en Puerto Rico, servimos orgullosamente a clientes de Estados Unidos, viajeros del Caribe y huéspedes de América Latina — sin pasaporte requerido, misma zona horaria, servicio completamente bilingüe.",
    faqLabel: "Preguntas Frecuentes",
    faqTitle: "Preguntas",
    faqTitleHighlight: "Frecuentes",
    faqDescription: "Todo lo que necesitas saber sobre trabajar con SJU Luxe Travel.",
    faqs: [
      { question: "¿Vale la pena contratar un agente de viajes?", answer: "Absolutamente. Un agente de viajes profesional te ahorra tiempo, evita errores costosos y desbloquea beneficios exclusivos que no puedes obtener reservando en línea — como mejoras gratuitas, créditos de resort y experiencias VIP. En SJU Luxe Travel, manejamos cada detalle para que puedas concentrarte en disfrutar el viaje." },
      ...
      { question: "¿Trabajan con clientes fuera de Puerto Rico?", answer: "¡Sí! Como agente de viajes basado en Puerto Rico, servimos orgullosamente a clientes de Estados Unidos, viajeros del Caribe y huéspedes de América Latina, incluyendo la República Dominicana y Sudamérica. Puerto Rico ofrece la conveniencia de no requerir pasaporte para ciudadanos estadounidenses, la misma zona horaria de la Costa Este y servicio completamente bilingüe en inglés y español." },
  ...
  contact: {
    ...
    formDescription: "Solicita tu consulta gratuita de viajes de lujo. Completa el formulario con detalles sobre tu viaje soñado y tu agente de viajes te responderá dentro de 24 horas con recomendaciones personalizadas y próximos pasos.",
    fullName: "Nombre Completo",
    ...
    formSuccessBody: "Tu solicitud de consulta ha sido enviada. Un agente de viajes se comunicará contigo dentro de 24 horas.",
    formSuccessButton: "Enviar Otro Mensaje",
    locationBanner: "El corazón del Caribe — Tu agente de viajes para destinos internacionales",
  },
  viajesDeLujo: {
