...
const WhatLuxuryTravelMeans = lazy(
  () => import("./pages/blog/WhatLuxuryTravelMeans.tsx"),
);
const DoTravelAgentsSaveMoney = lazy(
  () => import("./pages/blog/DoTravelAgentsSaveMoney.tsx"),
);
...
const RiverCruisingNewGeneration = lazy(
  () => import("./pages/blog/RiverCruisingNewGeneration.tsx"),
);
const LunaDeMielPuertoRico2026 = lazy(
  () => import("./pages/blog/LunaDeMielPuertoRico2026.tsx"),
);
const CrucerosFluvialesComparativa = lazy(
  () => import("./pages/blog/CrucerosFluvialesComparativa.tsx"),
);
const ValeLaPenaAsesor2026 = lazy(
  () => import("./pages/blog/ValeLaPenaAsesor2026.tsx"),
);
const VuelosPuertoRicoPortugal = lazy(
  () => import("./pages/blog/VuelosPuertoRicoPortugal.tsx"),
);
const MaldivasDesdePuertoRico = lazy(
  () => import("./pages/blog/MaldivasDesdePuertoRico.tsx"),
);
const ServiciosConciergeViaje = lazy(
  () => import("./pages/blog/ServiciosConciergeViaje.tsx"),
);
const ViajesSinPasaporte = lazy(
  () => import("./pages/blog/ViajesSinPasaporte.tsx"),
);
const LuxurySoloFemaleTravel = lazy(
  () => import("./pages/blog/LuxurySoloFemaleTravel.tsx"),
);
...
const appRoutes = [
  ...
  {
    path: "/blog/what-luxury-travel-really-means",
    element: <WhatLuxuryTravelMeans />,
  },
  {
    path: "/blog/do-travel-agents-really-help-save-money",
    element: <DoTravelAgentsSaveMoney />,
  },
  {
    path: "/blog/micro-vacaciones-futuro-del-viaje",
    element: <MicroVacaciones />,
  },
  {
    path: "/blog/wellness-travel-intentional-luxury",
    element: <WellnessTravel />,
  },
  {
    path: "/blog/river-cruising-new-generation",
    element: <RiverCruisingNewGeneration />,
  },
  {
    path: "/blog/luna-de-miel-puerto-rico-2026",
    element: <LunaDeMielPuertoRico2026 />,
  },
  {
    path: "/blog/cruceros-fluviales-ama-vs-avalon-vs-riverside",
    element: <CrucerosFluvialesComparativa />,
  },
  {
    path: "/blog/vale-la-pena-asesor-viajes-2026",
    element: <ValeLaPenaAsesor2026 />,
  },
  {
    path: "/blog/vuelos-puerto-rico-portugal",
    element: <VuelosPuertoRicoPortugal />,
  },
  {
    path: "/blog/maldivas-desde-puerto-rico-guia",
    element: <MaldivasDesdePuertoRico />,
  },
  {
    path: "/blog/servicios-concierge-viaje",
    element: <ServiciosConciergeViaje />,
  },
  {
    path: "/blog/viajes-sin-pasaporte-desde-pr",
    element: <ViajesSinPasaporte />,
  },
  {
    path: "/blog/luxury-solo-female-travel",
    element: <LuxurySoloFemaleTravel />,
  },
  {
...
const App = () => (
 ...
 (LanguageContext detects the prefix and switches copy to Spanish). */}
                ...
                <Route
                  path="/blog/do-travel-agents-really-"
                  element={
                    <RedirectBlog to="/blog/do-travel-agents-really-help-save-money" />
                  }
                />
                <Route
                  path="/agencia-de-viajes-puerto-rico"
                  element={<AgenciaDeViajesPuertoRico />}
                />
                <Route
                  path="/blog/do-travel-agents-really"
                  element={
