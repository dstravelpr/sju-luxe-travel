...
const aboutImages = [
  {
    ...
    alt: "Daniel Santiago Díaz exploring international destinations",
  },
  {
    src: "/about/IMG_9540.jpg",
    alt: "Daniel Santiago Díaz bespoke travel experience",
  },
  {
  ...
  },
  {
    ...
    alt: "Daniel Santiago Díaz travel agent SJU Luxe Travel",
  },
  {
    src: "/about/IMG_0941.jpg",
    alt: "Daniel Santiago Díaz destination scouting",
  },
  {
    src: "/about/IMG_3214.jpg",
    alt: "Daniel Santiago Díaz international travel professional",
  },
  {
    src: "/about/IMG_2086.jpg",
    alt: "Daniel Santiago Díaz founder of SJU Luxe Travel",
  },
];
...
const aboutSchema = buildGraph(
  {
    ...
    url: ABOUT_URL,
    name: "Daniel Santiago Díaz — agente de viajes PR",
...
const About = () => {
  ...
  return (
    <Layout>
      <SEOHead
        title="About Daniel Santiago Díaz — Travel Agent in San Juan, PR"
        description="Meet Daniel Santiago Díaz — bilingual travel agent in San Juan, PR. 10+ years of experience, NCM Concierge perks, bespoke itineraries. Free consultation."
        titleEs="Sobre Daniel Santiago Díaz — Agente de Viajes en San Juan, PR"
        descriptionEs="Conoce a Daniel Santiago Díaz, agente bilingüe de viajes en San Juan, PR. +10 años de experiencia, beneficios NCM Concierge, itinerarios a medida."
        breadcrumbs={[
          { name: "Home", url: "https://www.sjuluxetravel.com" },
          {
            name: "About Daniel Santiago Díaz",
      ...
      <section className="pt-32 pb-16 bg-background text-center">
        <div className="container mx-auto px-6">
          ...
          <p className="font-body text-gold text-xs tracking-[0.25em] uppercase mt-3">
            Serving travelers since 2024
          </p>
          <div className="mt-10 max-w-md mx-auto">
            <img
              src="/about/hero-portrait.jpg"
              alt="Daniel Santiago Díaz, founder of SJU Luxe Travel, travel agent in Puerto Rico"
      ...
      <section className="py-20 bg-charcoal">
        <div className="container mx-auto px-6 max-w-5xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-start mb-16">
            ...
            <img
              src="/about/IMG_9540.jpg"
              alt="Daniel Santiago Díaz bespoke travel experience abroad"
