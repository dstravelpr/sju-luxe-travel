...
const FAQ_ITEMS = [
  {
    q: "¿Cuáles son los mejores destinos para viajar desde Puerto Rico?",
  ...
  {
    q: "¿Cómo reservo un viaje a medida con SJU Luxe Travel?",
  ...
  {
    q: "¿Qué ventajas tiene contratar una agencia de viajes boutique en lugar de reservar en línea?",
  ...
  {
    q: "¿Cuánto tiempo antes debo planificar mi viaje a medida?",
...
const PAGE_URL =
  "https://www.sjuluxetravel.com/viajes-de-lujo-desde-puerto-rico";
const schema = buildGraph(
  {
    "@type": "WebPage",
    "@id": `${PAGE_URL}#webpage`,
    url: PAGE_URL,
    name: "Viajes a medida desde Puerto Rico",
  ...
  },
  {
    "@type": "Service",
    "@id": `${PAGE_URL}#service`,
    name: "Travel Planning from Puerto Rico",
    description:
      "Bespoke travel planning for international destinations departing from San Juan, Puerto Rico.",
    provider: ORG_REF,
  ...
  breadcrumbList([
    ...
    { name: "Viajes a medida desde Puerto Rico", url: PAGE_URL },
  ]),
);
...
const ViajesDeLujo = () => {
  ...
  return (
    <Layout>
      <SEOHead
        title="Travel from Puerto Rico — Bespoke Itineraries | SJU Luxe Travel"
        description="Bespoke itineraries from San Juan, PR to the Maldives, Europe, Mexico and beyond. Bilingual service, no-passport U.S. destinations available."
        titleEs="viajes a medida desde Puerto Rico | SJU Luxe Travel"
        descriptionEs="itinerarios a medida personalizados desde PR a las Maldivas, Europa, México y más. Servicio bilingüe, sin pasaporte para destinos US."
        schemaJson={schema}
        emitHreflang
      />
        ...
        <div className="container mx-auto px-6 max-w-3xl">
          ...
          <div className="prose-custom space-y-6">
            ...
            <figure className="my-8 overflow-hidden rounded-lg gold-border">
              <img
                src={travelAgentDesk}
                alt="Planificación de viaje a medida: pasaporte, mapa y folletos sobre escritorio"
                loading="lazy"
                width={1280}
                height={832}
            ...
            <p
              className="text-muted-foreground text-base leading-relaxed"
              dangerouslySetInnerHTML={{ __html: d.whyP2 }}
            />
            ...
            <p
              className="text-muted-foreground text-base leading-relaxed"
              dangerouslySetInnerHTML={{ __html: d.destMaldives }}
            />
            <p
              className="text-muted-foreground text-base leading-relaxed"
              dangerouslySetInnerHTML={{ __html: d.destPortugal }}
            />
            <p
              className="text-muted-foreground text-base leading-relaxed"
              dangerouslySetInnerHTML={{ __html: d.destMexico }}
            />
            <p
              className="text-muted-foreground text-base leading-relaxed"
              dangerouslySetInnerHTML={{ __html: d.destCaribbean }}
            />
            <p
              className="text-muted-foreground text-base leading-relaxed"
              dangerouslySetInnerHTML={{ __html: d.destEurope }}
            />
            ...
            <ol className="space-y-3 text-muted-foreground text-base leading-relaxed list-none">
              {d.steps.map(([title, desc], i) => (
                <li key={i} className="flex items-start gap-3">
                  <span className="text-gold font-semibold mt-0.5">
                    {i + 1}.
                  </span>
                  <span>
          ...
          <RelatedArticles
            items={[
              ...
              {
                title: "Wellness travel: el lujo intencional",
                href: "/blog/wellness-travel-intentional-luxury",
                category: "Tendencias",
              },
            ]}
          />
