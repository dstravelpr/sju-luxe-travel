...
const schemaJson = buildGraph(
  {
    ...
    description:
      "84% of travelers under 35 want to take a river cruise. A travel agent explains why — and how to get the most out of the experience.",
    ...
    keywords: [
      ...
      "river cruise for young travelers",
    ],
    url: "https://www.sjuluxetravel.com/blog/river-cruising-new-generation",
    mainEntityOfPage:
      "https://www.sjuluxetravel.com/blog/river-cruising-new-generation",
  },
  {
    "@type": "FAQPage",
    mainEntity: [
      {
        "@type": "Question",
        name: "Are river cruises good for younger travelers?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Yes — according to CLIA (Cruise Lines International Association), Gen X and Millennials now make up the fastest-growing demographic in river cruising, with North American river cruise passengers up more than 20% year over year. Newer ships and itineraries offer real flexibility (dine when you want, choose your excursion intensity, skip the group tour), which matches what younger U.S. travelers actually want.",
        },
      },
      {
        "@type": "Question",
        name: "Which river cruise line is best?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "AmaWaterways for active gourmet travelers (onboard bikes, Michelin-recognized dining). Avalon Waterways for biggest panoramic views and flexible excursion choices. Riverside Luxury cruises (former Crystal River) for top-tier all-inclusive luxury with butler service. The right line depends on your travel style.",
        },
      },
      {
        "@type": "Question",
        name: "What's included in a river cruise?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Cabin, all meals, wines and beverages with dinner, guided shore excursions in every port, gratuities (on most lines), and transfers. There are no hidden fees the way ocean cruises layer them on — almost everything is bundled into the cruise fare.",
        },
      },
      {
        "@type": "Question",
        name: "What are the best river cruise destinations?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "The Danube (Vienna, Budapest, Bratislava), the Rhine (Cologne, Strasbourg, Basel), the Douro in Portugal (Porto wine country), and the Mekong (Vietnam and Cambodia) are the most-requested itineraries. The Seine (Paris to Normandy) and Rhône (Burgundy/Provence) are excellent secondary choices.",
        },
      },
      {
        "@type": "Question",
        name: "How do I book a river cruise from Puerto Rico?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Most river cruises depart from European cities, so the booking starts with finding the right SJU flight routing (typically via JFK, MIA or ATL) and a pre-cruise hotel night. A certified river cruise agent coordinates flights, hotels, transfers and the cruise as one package — often with extra perks on top.",
        },
      },
    ],
  },
  ...
  return (
    <Layout>
      <SEOHead
        ...
        title={
          isEs
            ? "Cruceros Fluviales: Ya No Son Solo Para Tus Padres"
            : "River Cruising Isn't Just for Your Parents Anymore"
        }
        description={
          isEs
            ? "El 84% de viajeros menores de 35 quiere hacer un crucero fluvial. Un agente de viaje a medida explica por qué y cómo aprovecharlo."
            : "84% of travelers under 35 want to take a river cruise. A travel agent explains why — and how to get the most out of the experience."
        }
        ...
        breadcrumbs={[
          ...
          {
            name: "River Cruising Isn't Just for Your Parents Anymore — And That Changes Everything",
            url: "https://www.sjuluxetravel.com/blog/river-cruising-new-generation",
          },
        ]}
      />
        ...
        <div className="container mx-auto px-6 max-w-3xl">
          ...
          <div className="aspect-[16/9] overflow-hidden rounded-lg gold-border mb-10">
            <img
              ...
              alt={
                isEs
                  ? "Crucero fluvial navegando el Danubio al atardecer junto a un castillo y viñedos"
                  : "River cruise ship sailing the Danube at sunset past a castle and vineyards"
              }
          ...
          <div className="prose-custom space-y-6">
            ...
            <h2 className="font-heading text-2xl text-foreground mt-10">
              {isEs
                ? "El verdadero problema: nadie está explicando el valor"
                : "The real problem: nobody's explaining the value"}
            </h2>
            ...
            <p className="text-muted-foreground text-base leading-relaxed">
              {isEs
                ? "El producto cumple. La gente que lo prueba lo entiende. Pero la industria está haciendo un trabajo pésimo comunicando por qué vale la pena antes de que alguien reserve. Este es exactamente el tipo de problema que resuelvo todos los días como "
                : "As a "}
              <Link
                to={localPath("/about")}
                className="text-gold hover:text-gold-light underline-offset-4 hover:underline"
              >
                {isEs ? "agente de viaje" : "Travel agent"}
              </Link>
              {isEs
            ...
            <p className="text-muted-foreground text-base leading-relaxed">
              ...
              {!isEs && (
                <Link
                  ...
                  className="text-gold hover:text-gold-light underline-offset-4 hover:underline"
                >
                  river cruises planned from Puerto Rico
                </Link>
              )}
              {isEs
                ? ""
            ...
            <p className="text-muted-foreground text-base leading-relaxed">
              {isEs
                ? "El Danubio, el Rin, el Duero en Portugal, el Mekong — son destinos de clase mundial que simplemente se experimentan mejor desde el agua. Y con cruceros desde San Juan, ni siquiera tienes que complicarte la vida con un itinerario enredado solo para llegar al barco."
                : ""}
            </p>

            <p className="text-foreground text-lg leading-relaxed font-heading italic">
              {isEs
                ? "Esto es lo que sé después de una década planificando viajes a medida por seis continentes: los mejores viajes son los que no te hacen pensar en logística. Simplemente estás ahí, presente, disfrutando cada momento. Los cruceros fluviales logran eso mejor que casi cualquier otra experiencia que he visto — y el hecho de que una nueva generación lo esté descubriendo es algo que me entusiasma de verdad."
            ...
            <h2 className="font-heading text-2xl text-foreground mt-12">
              {isEs
                ? "Preguntas Frecuentes sobre cruceros Fluviales"
                : "River cruise FAQs"}
            </h2>
            <div className="space-y-5">
              <div>
                <h3 className="font-heading text-lg text-foreground mb-2">
                  {isEs
                    ? "¿Son los cruceros fluviales para viajeros jóvenes?"
                    : "Are river cruises good for younger travelers?"}
                </h3>
                <p className="text-muted-foreground text-base leading-relaxed">
                  {isEs
                    ? "Sí — el 84% de los viajeros británicos de 18 a 34 años quiere hacer uno. Los barcos e itinerarios nuevos ofrecen flexibilidad real: cenas a tu hora, excursiones por intensidad, salir por tu cuenta."
                    : "Yes — 84% of UK travelers aged 18–34 want to. Newer ships and itineraries offer real flexibility: dine when you want, choose excursion intensity, explore solo."}
                </p>
              </div>
              <div>
                <h3 className="font-heading text-lg text-foreground mb-2">
                  {isEs
                    ? "¿Cuál línea fluvial es la mejor?"
                    : "Which river cruise line is best?"}
                </h3>
                <p className="text-muted-foreground text-base leading-relaxed">
                  {isEs
                    ? "AmaWaterways para gourmet activo. Avalon Waterways para vistas y flexibilidad. Riverside Luxury cruises (ex-Crystal) para el lujo más alto con servicio butler."
                    : "AmaWaterways for active gourmet. Avalon Waterways for views and flexibility. Riverside Luxury cruises (former Crystal) for top-tier luxury with butler service."}
                </p>
              </div>
              <div>
                <h3 className="font-heading text-lg text-foreground mb-2">
                ...
                <p className="text-muted-foreground text-base leading-relaxed">
                  {isEs
                    ? "Camarote, todas las comidas, vinos con cena, excursiones guiadas en cada puerto, propinas (en la mayoría de líneas) y traslados — todo dentro de la tarifa."
                    : "Cabin, all meals, wines with dinner, guided excursions every port, gratuities (on most lines), and transfers — all bundled."}
                </p>
              </div>
              <div>
                <h3 className="font-heading text-lg text-foreground mb-2">
                  {isEs
                    ? "¿Cuáles son los mejores destinos fluviales?"
                    : "What are the best river cruise destinations?"}
                </h3>
                <p className="text-muted-foreground text-base leading-relaxed">
                  {isEs
                    ? "Danubio (Viena, Budapest), Rin (Colonia, Estrasburgo), Duero en Portugal (Oporto y viñedos), y Mekong (Vietnam y Camboya)."
                    : "Danube (Vienna, Budapest), Rhine (Cologne, Strasbourg), Douro in Portugal (Porto and wine country), and Mekong (Vietnam and Cambodia)."}
                </p>
              </div>
              <div>
                <h3 className="font-heading text-lg text-foreground mb-2">
                  {isEs
                    ? "¿Cómo reservo un crucero fluvial desde Puerto Rico?"
                    : "How do I book a river cruise from Puerto Rico?"}
                </h3>
                <p className="text-muted-foreground text-base leading-relaxed">
                  {isEs
                    ? "Los cruceros salen de ciudades europeas, así que la reserva empieza con el ruteo SJU (vía JFK, MIA o ATL) y una noche pre-crucero. Un agente coordina vuelos, hotel y crucero como un solo paquete."
                    : "Cruises depart from European cities, so booking starts with SJU routing (via JFK, MIA or ATL) and a pre-cruise hotel night. An agent coordinates flights, hotel and cruise as one package."}
                </p>
              </div>
            </div>
            ...
            <ul className="space-y-2 list-none">
              <li className="flex items-start gap-3">
                ...
                >
                  {isEs
                    ? "Cruceros fluviales desde Puerto Rico"
                    : "Luxury river cruises from Puerto Rico"}
                </Link>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-gold mt-1">→</span>
                ...
                >
                  {isEs
                    ...
                    : "Luxury ocean cruises from San Juan"}
                </Link>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-gold mt-1">→</span>
                ...
                >
                  {isEs
                    ? "¿Los agentes de viaje realmente ayudan a ahorrar?"
          ...
          >
            {isEs
              ? "¿Prefieres cruceros oceánicos desde San Juan? "
              : "Prefer ocean cruises from San Juan? "}
            <Link
              to={localPath("/cruceros-de-lujo-desde-san-juan")}
              className="text-gold hover:text-gold-light underline font-semibold"
            >
              {isEs
                ? "Ver cruceros desde San Juan →"
                : "See luxury cruises from San Juan →"}
            </Link>
          </p>
          <div className="mt-16 text-center py-12 gold-border rounded-lg">
            <h3 className="font-heading text-2xl text-foreground mb-3">
              {isEs
                ...
                : "Curious but haven't booked yet?"}
            </h3>
          ...
          <div className="mt-12 pt-8 border-t border-gold/20">
            <p className="text-muted-foreground text-sm leading-relaxed">
              {isEs
                ? "Daniel Santiago Díaz es el fundador de SJU Luxe Travel, una agencia de viajes boutique en San Juan, Puerto Rico. Como especialista certificado en cruceros fluviales y agente independiente de NCM Concierge, diseña itinerarios a medida para viajeros en Estados Unidos, el Caribe y América Latina."
                : "Daniel Santiago Díaz is the founder of SJU Luxe Travel, a boutique travel agency based in San Juan, Puerto Rico. As a certified river cruise specialist and independent agent of NCM Concierge, he designs bespoke river cruise itineraries for travelers across the US, Caribbean, and Latin America."}
            </p>
