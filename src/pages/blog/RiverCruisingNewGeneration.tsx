  ...
  return (
    <Layout>
      <SEOHead
        ...
        description={
          isEs
            ? "El 84% de viajeros menores de 35 quiere hacer un crucero fluvial. Un agente de viaje de lujo explica por qué y cómo aprovecharlo."
          ...
          <div className="prose-custom space-y-6">
            ...
            <p className="text-muted-foreground text-base leading-relaxed">
              ...
              <Link to={localPath("/about")} className="text-gold hover:text-gold-light underline-offset-4 hover:underline">
                {isEs ? "agente de viaje" : "luxury travel agent"}
              </Link>
              {isEs
            ...
            <ul className="space-y-2 list-none">
              ...
              <li className="flex items-start gap-3"><span className="text-gold mt-1">→</span><Link to={localPath("/blog/do-travel-agents-really-help-save-money")} className="text-gold hover:text-gold-light underline">{isEs ? "¿Los agentes de viaje realmente ayudan a ahorrar?" : "Do travel agents really help save money?"}</Link></li>
