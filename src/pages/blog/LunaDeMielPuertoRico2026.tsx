      ...
      <article className="pt-28 pb-20 bg-background">
        <div className="container mx-auto px-6 max-w-3xl">
          ...
          <div className="prose-custom space-y-6 text-muted-foreground text-base leading-relaxed">
            ...
            <p><strong className="text-foreground">{isEs ? "Presupuesto:" : "Budget:"}</strong> {isEs ? "$18,000–$45,000 por pareja para 7 noches con vuelos en business, villa sobre el agua y traslado en hidroavión." : "$18,000–$45,000 per couple for 7 nights with business-class flights, overwater villa and seaplane transfer."}</p>
            ...
            <p><strong className="text-foreground">{isEs ? "Presupuesto:" : "Budget:"}</strong> {isEs ? "$22,000–$50,000 por pareja para 10 noches con vuelos premium y dos bungalows sobre el agua." : "$22,000–$50,000 per couple for 10 nights with premium flights and two overwater bungalows."}</p>
            ...
            <p><strong className="text-foreground">{isEs ? "Presupuesto:" : "Budget:"}</strong> {isEs ? "$14,000–$28,000 por pareja con suites caldera y traslados en lancha privada." : "$14,000–$28,000 per couple with caldera suites and private speedboat transfers."}</p>
            ...
            <p><strong className="text-foreground">{isEs ? "Presupuesto:" : "Budget:"}</strong> {isEs ? "$16,000–$32,000 por pareja con hoteles 5★ y un día completo de yate privado." : "$16,000–$32,000 per couple with 5★ hotels and a full day of private yacht."}</p>
            ...
            <p><strong className="text-foreground">{isEs ? "Presupuesto:" : "Budget:"}</strong> {isEs ? "$12,000–$22,000 por pareja — el mejor valor de esta lista." : "$12,000–$22,000 per couple — the best value on this list."}</p>
            ...
            <p><strong className="text-foreground">{isEs ? "Presupuesto:" : "Budget:"}</strong> {isEs ? "$25,000–$60,000 por pareja — el safari de lujo es el gasto más alto." : "$25,000–$60,000 per couple — luxury safari is the biggest line item."}</p>
