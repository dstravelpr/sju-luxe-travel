...
const FAQ_ITEMS = [
  {
    q: "¿Cuándo debo empezar a planificar mi luna de miel?",
  ...
  },
  {
    ...
    a: "Las Maldivas, Portugal, Santorini, Italia y el Caribe son nuestros destinos más solicitados para parejas. Seleccionamos propiedades que ofrecen detalles románticos exclusivos para nuestra clientela.",
  },
  {
...
const schema = buildGraph(
  {
    ...
    "@id": `${PAGE_URL}#webpage`,
    url: PAGE_URL,
    name: "Luna de Miel desde Puerto Rico",
  ...
  },
  {
    "@type": "Service",
    "@id": `${PAGE_URL}#service`,
    name: "Honeymoon Travel Planning",
    description:
      "Personalized honeymoon itineraries from Puerto Rico to top romantic destinations worldwide.",
    provider: ORG_REF,
  ...
  breadcrumbList([
    ...
    { name: "Luna de Miel", url: PAGE_URL },
  ]),
);
...
const LunaDeMiel = () => {
  ...
  return (
    <Layout>
      <SEOHead
        title="Honeymoons from Puerto Rico — Bespoke Itineraries | SJU Luxe Travel"
        description="Plan your honeymoon from San Juan, PR: Maldives, Amalfi, Santorini, Bora Bora & more. Bespoke romantic itineraries with concierge perks."
        titleEs="Luna de Miel desde PR | SJU Luxe Travel"
        descriptionEs="Planifica tu luna de miel desde San Juan, PR. Maldivas, Amalfi, Santorini, Bora Bora y más — itinerarios románticos a medida."
        schemaJson={schema}
        emitHreflang
      />
      ...
      <article className="pt-32 pb-20 bg-background">
        <div className="container mx-auto px-6 max-w-3xl">
          ...
          <div className="prose-custom space-y-6">
            ...
            <p
              className="text-muted-foreground text-base leading-relaxed"
              dangerouslySetInnerHTML={{ __html: d.destinationsIntro }}
            />
            ...
            <p
              className="text-muted-foreground text-base leading-relaxed"
              dangerouslySetInnerHTML={{ __html: d.whenP1 }}
            />
            <p className="text-muted-foreground text-base leading-relaxed">
              {d.whenP2}
            </p>
            ...
            <p className="text-muted-foreground text-base leading-relaxed">
              ¿Quieres ideas concretas por destino? Lee nuestros{" "}
              <Link
              ...
              con itinerarios, rutas de vuelo y presupuestos.
            </p>
          </div>
          ...
          <RelatedArticles
            items={[
              {
                title: "Luna de miel en Puerto Rico 2026: mejores destinos",
                href: "/blog/luna-de-miel-puerto-rico-2026",
                category: "Luna de Miel",
              },
              {
                title: "Maldivas desde Puerto Rico: guía completa",
                href: "/blog/maldivas-desde-puerto-rico-guia",
                category: "Destinos",
              },
              {
                title: "solo female travel from Puerto Rico",
                href: "/blog/luxury-solo-female-travel",
                category: "Guía",
              },
            ]}
          />
          ...
          <FAQSection
            heading="Preguntas Frecuentes sobre Lunas de Miel"
            items={FAQ_ITEMS}
          />
