...
const webPageEn = {
  ...
  name: "SJU Luxe Travel — boutique travel agency in San Juan, Puerto Rico",
...
const webPageEs = {
  ...
  name: "Agencia de Viajes en Puerto Rico — SJU Luxe Travel",
  isPartOf: WEBSITE_REF,
  about: { "@id": ORG_ID },
  inLanguage: "Es-PR",
};
...
const faqPageEn = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Yes, SJU Luxe Travel is fully bilingual. We serve English-speaking clients throughout the US, Caribbean, and Latin America with the same level of personalized bespoke travel planning.",
      },
    },
  ],
};
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "SJU Luxe Travel es una agencia de viajes boutique con base en San Juan, Puerto Rico, especializada en itinerarios internacionales exclusivos, cruceros y lunas de miel a medida.",
      },
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Nos especializamos en viajes internacionales, cruceros desde San Juan, cruceros fluviales por Europa, lunas de miel exclusivas y viajes corporativos de incentivo.",
      },
    },
  ],
};
...
const Index = () => {
  ...
  const services = [
    {
      icon: Compass,
      title: t.home.services.curatedItineraries,
    ...
    {
      icon: Globe,
      title: t.home.services.internationalExpertise,
      description: t.home.services.internationalExpertiseDesc,
    },
    {
      icon: Shield,
  ...
  const destinations = [
    ...
    },
    {
      ...
      title: t.home.mexico,
      subtitle: t.home.mexicoSub,
      to: localPath("/destinations/mexico"),
    },
    {
      image: cruiseImg,
      imageWebp: undefined,
      title: t.home.cruises,
      subtitle: t.home.cruisesSub,
  ...
  return (
    <Layout>
      <SEOHead
        title="SJU Luxe Travel | Boutique Travel Agency San Juan Puerto Rico"
        description="boutique travel agency in San Juan, Puerto Rico. Bespoke itineraries to the Maldives, Portugal, Mexico & beyond with exclusive concierge perks."
        titleEs="Agencia de Viajes en Puerto Rico | SJU Luxe Travel"
        descriptionEs="SJU Luxe Travel es tu agencia de viajes boutique en Puerto Rico. Itinerarios exclusivos, cruceros desde San Juan, lunas de miel y más. Consulta gratis."
      ...
      <section className="hero-section relative min-h-[92vh] md:min-h-screen flex items-center justify-center overflow-hidden pt-24 pb-16">
        <div className="absolute inset-0 overflow-hidden">
          <Picture
            src={heroBg}
            webpSrc={heroBgWebp}
            alt="Overwater villas at sunset — bespoke travel curated by SJU Luxe Travel"
            width={1920}
            height={1080}
            className="ken-burns absolute inset-0 w-full h-full object-cover object-center"
            fetchPriority="high"
            decoding="async"
          />
        </div>
        ...
        <div className="relative z-10 container mx-auto px-6 text-center">
          <img
            src={logo}
            alt="SJU Luxe Travel"
            className="hidden md:block h-28 w-28 mx-auto mb-10 animate-fade-in object-contain"
          />
          ...
          <div className="flex justify-center animate-fade-in-delay">
            <Link
              ...
              className="hero-ghost-btn pill-cta inline-flex items-center gap-3 px-10 py-4 border border-gold text-gold font-body text-xs font-semibold tracking-[0.25em] uppercase hover:bg-gold/10"
            >
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, index) => (
              <div
                key={index}
                className="p-10 bg-background gold-border gold-border-hover rounded-sm text-center group transition-colors duration-500"
              >
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-16 gap-8">
            <div>
              ...
              <h2 className="font-heading text-4xl md:text-5xl lg:text-6xl leading-tight text-foreground mt-6">
                ...
                <span className="text-gold-gradient italic">
                  {t.home.showcaseTitleHighlight}
                </span>
              </h2>
              <p className="text-muted-foreground text-lg mt-6 max-w-xl">
                {t.home.destinationsDescription}
              </p>
            </div>
            <Link
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {destinations.map((dest, index) => (
              <Link
                key={index}
                to={dest.to}
                className="group relative aspect-[3/4] overflow-hidden rounded-sm gold-border gold-border-hover"
              >
                <Picture
                  src={dest.image}
                  webpSrc={dest.imageWebp}
                  alt={`${dest.title} — bespoke travel destination curated by SJU Luxe Travel`}
                  className="absolute inset-0 w-full h-full object-cover transition-transform duration-[1400ms] ease-out group-hover:scale-105"
                  loading="lazy"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-background via-background/25 to-transparent" />
                <div className="absolute bottom-0 left-0 right-0 p-6">
                  <p className="text-gold text-[11px] tracking-[0.25em] uppercase mb-2 opacity-70 group-hover:opacity-100 transition-opacity duration-700">
                    {dest.subtitle}
                  </p>
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-14 md:gap-20 items-center max-w-5xl mx-auto">
            ...
            <div>
              ...
              <h2 className="font-heading text-4xl md:text-5xl leading-tight text-foreground mt-6">
                {t.home.founderName}
              </h2>
